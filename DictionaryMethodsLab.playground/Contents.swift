 ...
 */
// write your code here
starWarsVillians.append("Klyo Ren")
 ...
 */
// write your code here
let removeBounty = starWarsCharacters.removeValueForKey("Bounty Hunters")

if let removed = removeBounty {
    print ("Removed Bounty Hunter")
}
...
if let heroes = starWarsCharacters["Heroes"] { //I TOOK WAY TOO LONG TO FIGURE THIS OUT
    for hero in heroes {
        print(hero)
    }
}
